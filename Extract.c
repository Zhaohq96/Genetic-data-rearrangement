...
void help ()
{
	...
	printf("Required flag:\n");
	printf("\t-i: path to input ms file (str)\n");
	printf("\t-o: path to output folder (str), automatically create if it doesn't exist\n");
	printf("\t-a: rearrangement algorithm that will be executed firstly (int), it requires one of the following values\n");
	printf("\t\t0: Original-no-sorting\n");
	printf("\t\t1: Row-decreasing-hamming-weight\n");
	printf("\t\t2: Row-decreasing-decimal-value\n");
	printf("\t\t3: Row-decreasing-correlation\n");
	printf("\t\t4: Row-increasing-hamming-distance\n");
	printf("\t\t5: Row-hamming-weight-increasing-hamming-distance\n");
	printf("\t\t6: Column-decreasing-derived-allele-frequency\n");
	printf("\t\t7: Column-decreasing-correlation\n");
	printf("\t\t8: Column-decreasing-minor-allele-frequency\n");
	printf("\t\t9: Column-decreasing-minor-allele-frequency-with-bit-flipping\n");
	printf("\t\t10: Column-decreasing-hamming-distance\n");
	printf("\t\t11: Column-adjacent-max-correlation\n");
	printf("\t\t11: Column-adjacent-max-correlation-on-different-sides\n");
	printf("\t-b: rearrangement algorithm that will be executed secondly (int), it requires one of the following values\n");
	printf("\t\t0: Original-no-sorting\n");
	printf("\t\t1: Row-decreasing-hamming-weight\n");
	printf("\t\t2: Row-decreasing-decimal-value\n");
	printf("\t\t3: Row-decreasing-correlation\n");
	...
	printf("\t\t11: Column-adjacent-max-correlation\n");
	printf("\t\t11: Column-adjacent-max-correlation-on-different-sides\n");
	printf("\t-h: number of samples (int)\n");
	printf("\t-w: number of SNPs to be extracted (int)\n");
...
{
	int opt;
	const char *optstring = "i:a:b:c:h:w:s:l:r:g:o:H";
	int  win_snp=0, samples=0, win_site=5000, length=100000, min_snp=1, grid_size=1, modeA=0, modeB=0;
//	char *modeA, *modeB;
	char *center;
	char *out_dir;
	char *file_name;
...
//				printf("%d ", positions[i]);
		...
		char **matrix_ori = (char**)malloc(sizeof(char*)*sam);
		for(i=0;i<sam;i++)
		{
...
//		char **matrix_par = (char**)malloc(sizeof(char*)*samples);
//		for(i=0;i<samples;i++)
//		{
//			matrix_par[i] = (char*)malloc(sizeof(char)*(sites+1));
//		}
